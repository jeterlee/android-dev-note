...
### [**2、MVPArt（框架）**](https://github.com/JessYanCoding/MVPArt)
此框架旨在解决传统 MVP 类和接口太多,并且 Presenter 和 View 通过接口通信过于繁琐,重用 Presenter 代价太大等问题


### [**3、MVPFrames（框架）**](https://github.com/DesignQu/MVPFrames)
这是一个基于 MVPArms 和 MVPArt 并整合了大量主流开源项目可高度配置化的 Android MVP 快速集成框架


### [**4、MvpApp（项目，暂无APK）**](https://github.com/Rukey7/MvpApp)
...
### [**5、KotlinMvp（项目）**](https://github.com/git-xuhao/KotlinMvp)
...
### [**6、QBox（项目）**](https://github.com/OCNYang/QBox)
...
### [**7、RxTools（工具类）**](https://github.com/vondear/RxTools)
...
### [**8、GeekNews（项目）**](https://github.com/codeestX/GeekNews)
...
### [**9、YiZhi（项目）**](https://github.com/Horrarndoo/YiZhi)
...
### [**10、awesome-java-leetcode（数据算法）**](https://github.com/Blankj/awesome-java-leetcode)
...
### [**11、FanChat（基于黑马程序员即时通讯项目，有公开视频教程）**](https://github.com/uncleleonfan/FanChat)
本项目是即时通讯的示例项目，使用了MVP模式，集成了环信SDK和Bmob后端云，展示了即时通讯基本功能的实现，包括注册登录，退出登录，联系人列表，添加好友，删除好友，收发消息，消息提醒等功能。


### [**12、MinimalistWeather（项目，暂无APK）**](https://github.com/BaronZ88/MinimalistWeather)
...
### [**13、LGank（项目）**](https://github.com/leonHua/LGank)
...
### [**14、MVP（项目+架构）**](https://github.com/SuperMan42/MVP)
App based on Material Design + MVP + Rxjava + Retrofit + Okhttp + RecyclerView + Glide + cache + theme + others + 全民直播 + 高德选址



### [**15、Android-ZBLibrary（项目）**](https://github.com/TommyLemon/Android-ZBLibrary)
...
### [**16、FreeBook（项目）**](https://github.com/80945540/FreeBook)
基于MVP模式开发的带缓存网络爬虫,采用最流行框架搭建,干货多多


### [**17、HappyPlayer5（项目）**](https://github.com/zhangliangming/HappyPlayer5)
乐乐音乐5.0主要是基于ijkplayer框架开发的Android音乐播放器，它支持多种音频格式(mp3,ape,flac等)和动感歌词(ksc,krc,hrcs等)、翻译和音译歌词，界面高仿酷狗。


### [**18、SocialLibrary（库）**](https://github.com/extfff/SocialLibrary)
主要提供内容：
